...
export function AdminDashboard({ currentUserId }: { currentUserId: string }) {
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"} className="min-h-screen bg-[#f4f6f9]">
      ...
      {/* ══ HEADER ══════════════════════════════════════════════════════════ */}
      <header className="bg-[#0a2540] sticky top-0 z-40 shadow-2xl">
          ...
          >
            {tabs.map((tb) => (
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-[13px] font-semibold transition-all ${isRTL ? "flex-row-reverse" : ""} ${tab === tb.key ? "bg-white/[0.12] text-white shadow-inner border border-white/[0.1]" : "text-white/40 hover:text-white/80 hover:bg-white/[0.05]"}`}
              >
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <button
          onClick={() => setView("add")}
          className={`flex items-center gap-2 bg-[#0a2540] hover:bg-[#0d3060] text-white font-bold px-6 py-3 rounded-xl text-[14px] shadow-lg shadow-[#0a2540]/20 transition-all hover:-translate-y-0.5 ${isRTL ? "flex-row-reverse" : ""}`}
        >
          ...
          {courses.map((c) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <div
                  className={`flex items-center gap-3 text-slate-400 text-[12px] mb-5 ${isRTL ? "flex-row-reverse" : ""}`}
                >
                  <span
                ...
                >
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-[12px] font-bold border transition-all ${isRTL ? "flex-row-reverse" : ""} ${c.published ? "bg-slate-50 text-slate-500 border-slate-200 hover:bg-red-50 hover:text-red-500 hover:border-red-100" : "bg-emerald-50 text-emerald-600 border-emerald-100 hover:bg-emerald-100"}`}
                  >
                    {c.published ? (
                      <>
      ...
      <form onSubmit={submit}>
        <div className="grid xl:grid-cols-3 gap-7">
          ...
          <div className="xl:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
              <div
                className={`flex items-center justify-between pb-5 mb-6 border-b border-slate-100 ${isRTL ? "flex-row-reverse" : ""}`}
              >
                <div
                  className={`flex items-center gap-3 ${isRTL ? "flex-row-reverse" : ""}`}
                >
              ...
              <div className="space-y-3">
                {videos.map((video, i) => (
                  ...
                  >
                    <div
                      className={`flex items-center gap-3 p-4 bg-[#f8f9fc] ${isRTL ? "flex-row-reverse" : ""}`}
                    >
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 text-[12px] font-bold px-3.5 py-2.5 rounded-xl border transition-all flex-shrink-0 bg-white text-slate-500 border-slate-200 hover:border-[#00b4d8] hover:text-[#00b4d8] ${isRTL ? "flex-row-reverse" : ""}`}
                      >
                    ...
                    {(video.titleEn || video.titleAr || video.duration) && (
                      <div
                        className={`px-4 py-2.5 bg-white border-t border-slate-100 flex items-center gap-4 text-[12px] text-slate-400 flex-wrap ${isRTL ? "flex-row-reverse" : ""}`}
                      >
                        {video.titleEn && (
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
              ...
              <div
                ...
                className={`flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all select-none ${isRTL ? "flex-row-reverse" : ""} ${published ? "border-emerald-200 bg-emerald-50/60" : "border-slate-200 bg-slate-50"}`}
              >
                <div
      ...
      {videoPopup !== null && videos[videoPopup] && (
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          ...
          >
            ...
            <div className="p-8">
              <div
                className={`flex items-center justify-between mb-7 ${isRTL ? "flex-row-reverse" : ""}`}
              >
                <div
                  className={`flex items-center gap-3 ${isRTL ? "flex-row-reverse" : ""}`}
                >
